...
function SvgFx({ p }) {
    return (React.createElement("defs", null,
        React.createElement("linearGradient", { id: p + "Metal", x1: "0", y1: "0", x2: "1", y2: "0" },
            React.createElement("stop", { offset: "0", stopColor: "#4e5e73" }),
            React.createElement("stop", { offset: "0.18", stopColor: "#93a7be" }),
            React.createElement("stop", { offset: "0.45", stopColor: "#e9eff7" }),
            React.createElement("stop", { offset: "0.62", stopColor: "#c3d0e0" }),
            React.createElement("stop", { offset: "1", stopColor: "#485a70" })),
        React.createElement("linearGradient", { id: p + "Nose", x1: "0", y1: "0", x2: "1", y2: "0" },
            React.createElement("stop", { offset: "0", stopColor: "#137a6f" }),
            React.createElement("stop", { offset: "0.45", stopColor: "#8df7ea" }),
            React.createElement("stop", { offset: "1", stopColor: "#0d5a52" })),
        React.createElement("linearGradient", { id: p + "Band", x1: "0", y1: "0", x2: "1", y2: "0" },
            React.createElement("stop", { offset: "0", stopColor: "#9a3f1c" }),
            React.createElement("stop", { offset: "0.45", stopColor: "#ffab7e" }),
            React.createElement("stop", { offset: "1", stopColor: "#8c3a1a" })),
        React.createElement("linearGradient", { id: p + "Bell", x1: "0", y1: "0", x2: "0", y2: "1" },
            React.createElement("stop", { offset: "0", stopColor: "#3d5169" }),
            React.createElement("stop", { offset: "0.5", stopColor: "#182636" }),
            React.createElement("stop", { offset: "1", stopColor: "#0b141f" })),
        React.createElement("linearGradient", { id: p + "Flame", x1: "0", y1: "0", x2: "0", y2: "1" },
            React.createElement("stop", { offset: "0", stopColor: "#fff4c8" }),
            React.createElement("stop", { offset: "0.35", stopColor: "#ffc069" }),
            React.createElement("stop", { offset: "1", stopColor: "#ff7a45", stopOpacity: "0.12" })),
        React.createElement("linearGradient", { id: p + "FuelC", x1: "0", y1: "0", x2: "1", y2: "0" },
            React.createElement("stop", { offset: "0", stopColor: "#1e9c90" }),
            React.createElement("stop", { offset: "0.5", stopColor: "#6ff2e4" }),
            React.createElement("stop", { offset: "1", stopColor: "#178278" })),
        React.createElement("linearGradient", { id: p + "FuelG", x1: "0", y1: "0", x2: "1", y2: "0" },
            React.createElement("stop", { offset: "0", stopColor: "#b08a1e" }),
            React.createElement("stop", { offset: "0.5", stopColor: "#ffe08a" }),
            React.createElement("stop", { offset: "1", stopColor: "#9c7a17" })),
        React.createElement("radialGradient", { id: p + "Ocean", cx: "0.38", cy: "0.36", r: "0.68" },
            React.createElement("stop", { offset: "0", stopColor: "#5da2e0" }),
            React.createElement("stop", { offset: "0.5", stopColor: "#2a6aad" }),
            React.createElement("stop", { offset: "0.82", stopColor: "#16457f" }),
            React.createElement("stop", { offset: "1", stopColor: "#0a2c55" })),
        React.createElement("linearGradient", { id: p + "Night", x1: "0", y1: "0", x2: "1", y2: "0" },
            React.createElement("stop", { offset: "0.45", stopColor: "#020814", stopOpacity: "0" }),
            React.createElement("stop", { offset: "1", stopColor: "#020814", stopOpacity: "0.6" }))));
}
/* =================================================================
...
function RocketDiagram() {
    ...
    const seam = (x1, x2, ys) => ys.map(yy => (React.createElement("line", { key: yy, x1: x1, y1: yy, x2: x2, y2: yy, stroke: "#42546a", strokeWidth: "0.9", style: { pointerEvents: "none" } })));
    ...
    return (React.createElement("div", { className: "gfx rk-wrap" },
        React.createElement("svg", { className: "rk-svg", viewBox: "0 0 240 400", role: "img", "aria-label": "Interactive rocket diagram" },
            React.createElement(SvgFx, { p: "rk" }),
            React.createElement("g", { style: styleFor("fairing", "#4AF0E0"), onClick: () => setSel("fairing") },
                React.createElement("path", { d: "M150,14 C172,58 176,84 176,96 L124,96 C124,84 128,58 150,14 Z", ...shape("fairing", "#4AF0E0"), fill: "url(#rkNose)" }),
                React.createElement("rect", { x: "124", y: "96", width: "52", height: "24", ...shape("fairing", "#4AF0E0"), fill: "url(#rkNose)" })),
            ...
            React.createElement("g", { style: styleFor("interstage", "#FF7A45"), onClick: () => setSel("interstage") },
                React.createElement("rect", { x: "127", y: "190", width: "46", height: "22", ...shape("interstage", "#FF7A45"), fill: "url(#rkBand)" })),
            ...
            React.createElement("g", { style: styleFor("engines", "#FF7A45"), onClick: () => setSel("engines") },
                ...
                React.createElement("path", { d: "M132,360 L130,386 L144,386 L142,360 Z", ...shape("engines", "#FF7A45"), fill: "url(#rkBell)" }),
                React.createElement("path", { d: "M145,360 L143,388 L157,388 L155,360 Z", ...shape("engines", "#FF7A45"), fill: "url(#rkBell)" }),
                React.createElement("path", { d: "M158,360 L156,386 L170,386 L168,360 Z", ...shape("engines", "#FF7A45"), fill: "url(#rkBell)" })),
...
function LaunchSequence() {
    ...
    return (React.createElement("div", { className: "gfx" },
        ...
        React.createElement("svg", { className: "ls-svg", viewBox: "0 0 300 320", role: "img", "aria-label": "Launch sequence animation" },
            ...
            React.createElement(SvgFx, { p: "lf" }),
            ...
            idx === 3 && (React.createElement("g", { className: "ls-fall" },
                React.createElement("rect", { x: "-7", y: "-26", width: "14", height: "26", rx: "2", fill: "url(#lfMetal)", stroke: "#52E07C", strokeWidth: "1.2", strokeOpacity: "0.7" }),
                React.createElement("path", { d: "M-7,-6 L-15,2 L-7,2 Z", fill: "url(#lfMetal)", stroke: "#52E07C", strokeWidth: "1", strokeOpacity: "0.7" }))),
            ...
            React.createElement("g", { style: { transform: `translate(${tx}px, ${ty}px) rotate(${p.tilt}deg)`, transformBox: "fill-box", transition: "transform 1.1s cubic-bezier(.45,.05,.35,1)" } },
                flame > 0 && (React.createElement("path", { className: "ls-flame", d: `M-6,0 L0,${22 + 26 * flame} L6,0 Z`, fill: "url(#lfFlame)", opacity: flame })),
                idx < 3 && React.createElement("rect", { x: "-7", y: "-32", width: "14", height: "26", rx: "2", fill: "url(#lfMetal)", stroke: "#52E07C", strokeWidth: "1.2", strokeOpacity: "0.7" }),
                React.createElement("rect", { x: "-6", y: "-58", width: "12", height: idx < 3 ? 26 : 52, rx: "2", fill: "url(#lfMetal)", stroke: "#F5C842", strokeWidth: "1.2", strokeOpacity: "0.7" }),
                idx < 4
                    ? React.createElement("path", { d: "M0,-80 L7,-58 L-7,-58 Z", fill: "url(#lfNose)", stroke: "#4AF0E0", strokeWidth: "1.2", strokeOpacity: "0.8" })
                    : idx < 5 && React.createElement("rect", { x: "-4", y: "-66", width: "8", height: "8", rx: "1", fill: "#4AF0E0" }),
                React.createElement("path", { d: "M-7,-6 L-5,2 L5,2 L7,-6 Z", fill: "url(#lfBell)", stroke: "#FF7A45", strokeWidth: "1", strokeOpacity: "0.8" })),
...
function Launch3D() {
    ...
    useEffect(() => {
        ...
        const makeBodyTex = () => {
            ...
            gr.addColorStop(0, "#75899f");
            gr.addColorStop(0.25, "#e6edf5");
            gr.addColorStop(0.5, "#aebdd0");
            gr.addColorStop(0.75, "#e6edf5");
            gr.addColorStop(1, "#75899f");
            x.fillStyle = gr;
            x.fillRect(0, 0, 256, 256);
            x.strokeStyle = "rgba(38,54,74,.85)";
            x.lineWidth = 3;
            [42, 106, 170, 234].forEach(y => { x.beginPath(); x.moveTo(0, y); x.lineTo(256, y); x.stroke(); });
            x.strokeStyle = "rgba(38,54,74,.5)";
            x.lineWidth = 1.5;
            [64, 128, 192].forEach(vx => { x.beginPath(); x.moveTo(vx, 0); x.lineTo(vx, 256); x.stroke(); });
            x.fillStyle = "rgba(60,80,105,.45)";
            x.fillRect(120, 118, 18, 30);
            x.strokeStyle = "rgba(255,255,255,.3)";
            x.strokeRect(120, 118, 18, 30);
        ...
        dropped.traverse(o => { if (o.isMesh)
            o.material = dropMat; });
        const wisp = new T.Mesh(new T.ConeGeometry(0.28, 1.6, 12, 1, true), new T.MeshBasicMaterial({ color: 0xffb070, transparent: true, opacity: 0.5, side: T.DoubleSide, depthWrite: false }));
        wisp.position.y = -0.6;
        ...
        for (let i = 0; i < bN; i++) {
            bP[i * 3 + 1] = -999;
            bV.push(new T.Vector3());
            bR.push(new T.Vector3());
        }
        ...
        const tick = () => {
            ...
            if (ph !== prevPh) {
                ...
                if (ph < 3) {
                    dropped.visible = false;
                    fairings.forEach(m => m.visible = false);
                }
                if (ph < 4) {
                    fairings.forEach(m => m.visible = false);
                    nose.visible = true;
            ...
            vehVX = (x - lastX) / Math.max(dt, 1e-4);
            vehVY = (y - lastY) / Math.max(dt, 1e-4);
            lastX = x;
            lastY = y;
            ...
            if (burstLife > 0) {
                ...
                bBase.x += dropRel.x * 0.5;
                bBase.y += dropRel.y * 0.5;
                for (let i = 0; i < bN; i++) {
                    bR[i].addScaledVector(bV[i], dt);
                    bP[i * 3] = bBase.x + bR[i].x;
                    bP[i * 3 + 1] = bBase.y + bR[i].y;
                    bP[i * 3 + 2] = bBase.z + bR[i].z;
                }
            ...
            for (let i = 0; i < PN; i++) {
                ...
                if (!alive && emit > 0) {
                    ...
                    if (cam.position.y - arr[i * 3 + 1] > 17 || nozzle.y - arr[i * 3 + 1] > 10)
                        arr[i * 3 + 1] = -999;
                }
            }
    ...
    return (React.createElement("div", { className: "gfx" },
        React.createElement("div", { className: "l3d-wrap" },
            ...
            React.createElement("div", { className: "l3d-horizon", style: { opacity: horizonOpacity }, "aria-hidden": "true" }),
            React.createElement("div", { className: "l3d-ruler", "aria-hidden": "true" },
                React.createElement("div", { className: "lr-track" },
                    [0, 100, 200, 300].map(v => (React.createElement("span", { key: v, className: "lr-tick", style: { bottom: (v / RULER_MAX * 100) + "%" } }, v))),
                    React.createElement("span", { className: "lr-karman", style: { bottom: (100 / RULER_MAX * 100) + "%" } }, "SPACE"),
                    React.createElement("span", { className: "lr-marker", style: { bottom: rulerPct + "%" } }, "\u25B6"))),
            React.createElement("div", { className: "l3d-hud" },
                React.createElement("div", { className: "hud-clock" },
                    "T+",
                    mm,
                    ":",
                    ss),
                React.createElement("div", { className: "hud-phase" }, p.name.toUpperCase()),
                React.createElement("div", { className: "hud-metric" },
                    React.createElement("span", null, "VEL"),
                    React.createElement("b", null, spd.toFixed(2)),
                    React.createElement("i", null, "km/s")),
                React.createElement("div", { className: "hud-bar" },
                    React.createElement("div", { style: { width: Math.min(100, spd / 7.8 * 100) + "%" } })),
                React.createElement("div", { className: "hud-metric" },
                    React.createElement("span", null, "ALT"),
                    React.createElement("b", null, Math.round(alt)),
                    React.createElement("i", null, "km")),
                React.createElement("div", { className: "hud-bar" },
                    React.createElement("div", { style: { width: rulerPct + "%" } }))),
...
function OrbitVisualiser() {
    ...
    return (React.createElement("div", { className: "gfx ov-wrap" },
        React.createElement("svg", { className: "ov-svg", viewBox: "0 0 300 300", role: "img", "aria-label": "Orbit visualiser" },
            React.createElement(SvgFx, { p: "ov" }),
            React.createElement("circle", { cx: C, cy: C, r: "27.5", fill: "none", stroke: "#7fd4ff", strokeWidth: "2.6", opacity: "0.18" }),
            React.createElement("circle", { cx: C, cy: C, r: "25.4", fill: "none", stroke: "#9fe0ff", strokeWidth: "1", opacity: "0.3" }),
            React.createElement("g", { className: "ov-earth" },
                React.createElement("circle", { cx: C, cy: C, r: "24", fill: "url(#ovOcean)" }),
                React.createElement("path", { d: "M137,141 q6,-7 14,-4 q8,3 6,10 q-2,6 -10,6 q-9,1 -11,-5 q-2,-4 1,-7 Z", fill: "#3aa66b", opacity: "0.92" }),
                React.createElement("path", { d: "M155,150 q6,-3 10,2 q4,6 -1,11 q-6,5 -10,0 q-4,-5 -3,-9 q1,-3 4,-4 Z", fill: "#379f65", opacity: "0.85" }),
                React.createElement("path", { d: "M142,159 q5,-2 8,2 q2,4 -2,7 q-7,3 -9,-2 q-1,-4 3,-7 Z", fill: "#2f8f5b", opacity: "0.8" }),
                React.createElement("ellipse", { cx: "151", cy: "131", rx: "8", ry: "2.1", fill: "#eaf5ff", opacity: "0.5" }),
                React.createElement("ellipse", { cx: "146", cy: "168", rx: "6", ry: "1.7", fill: "#eaf5ff", opacity: "0.35" })),
            React.createElement("circle", { cx: C, cy: C, r: "24", fill: "url(#ovNight)", style: { pointerEvents: "none" } }),
            ORBITS.map(o => {
                ...
                return (React.createElement("g", { key: o.id, ...wrap },
                    React.createElement("path", { d: d, fill: "none", stroke: o.color, strokeWidth: isSel ? 7 : 4.5, opacity: dim ? 0.04 : 0.13, style: { transition: "opacity .3s" } }),
                    ...
                    React.createElement("g", { opacity: dim ? 0.3 : 1, style: { transition: "opacity .3s" } },
                        React.createElement("g", null,
                            React.createElement("circle", { r: "7", fill: o.color, opacity: "0.22" }),
                            React.createElement("circle", { r: "3.6", fill: o.color }),
                            React.createElement("circle", { r: "1.4", cx: "-1", cy: "-1", fill: "#ffffff", opacity: "0.55" }),
                            React.createElement("rect", { x: "-8", y: "-1.2", width: "4", height: "2.4", rx: "0.5", fill: o.color, opacity: "0.75" }),
                            React.createElement("rect", { x: "4", y: "-1.2", width: "4", height: "2.4", rx: "0.5", fill: o.color, opacity: "0.75" }),
...
function DeltaVBudget() {
    ...
    const segText = (v) => v >= 14 ? React.createElement("span", null,
        v,
        "%") : null;
    return (React.createElement("div", { className: "gfx" },
        React.createElement("div", { className: "dv-barwrap" },
            ...
            React.createElement("div", { className: "dv-bar" },
                ...
                React.createElement("div", { className: "dv-seg", style: { width: mass.str + "%", background: "var(--orange)" } }, segText(mass.str)),
        ...
        React.createElement("svg", { className: "dv-svg", viewBox: "0 0 200 300", role: "img", "aria-label": "Staging animation" },
            React.createElement(SvgFx, { p: "dv" }),
            React.createElement("g", { style: { opacity: deployed ? 0 : 1, transition: "opacity .4s ease" }, transform: "translate(25,0)" },
                stage1Gone && (React.createElement("g", { className: "dv-fall" },
                    React.createElement("rect", { x: "-18", y: "-46", width: "36", height: "92", rx: "3", fill: "url(#dvMetal)", stroke: "#52E07C", strokeWidth: "1.2", strokeOpacity: "0.7" }),
                    React.createElement("path", { d: "M-18,30 L-30,46 L-18,46 Z", fill: "url(#dvMetal)", stroke: "#52E07C", strokeWidth: "1", strokeOpacity: "0.7" }),
                    React.createElement("path", { d: "M18,30 L30,46 L18,46 Z", fill: "url(#dvMetal)", stroke: "#52E07C", strokeWidth: "1", strokeOpacity: "0.7" }))),
                phase === "burn1" && React.createElement("path", { className: "ls-flame", d: "M58,242 L70,290 L82,242 Z", fill: "url(#dvFlame)" }),
                phase === "burn2" && React.createElement("path", { className: "ls-flame", d: "M64,134 L70,168 L76,134 Z", fill: "url(#dvFlame)" }),
                React.createElement("g", null,
                    React.createElement("path", { d: "M70,40 L78,62 L62,62 Z", fill: "url(#dvNose)", stroke: "#52E07C", strokeWidth: "1.4", strokeOpacity: "0.8" }),
                    React.createElement("rect", { x: tank2.x, y: tank2.y, width: tank2.w, height: tank2.h, rx: "2", fill: "url(#dvMetal)", stroke: "#F5C842", strokeWidth: "1.2", strokeOpacity: "0.7" }),
                    React.createElement("rect", { x: tank2.x, y: tank2.y + (tank2.h - f2h), width: tank2.w, height: f2h, rx: "2", fill: "url(#dvFuelG)", opacity: "0.85", style: { transition: "height 2.4s linear, y 2.4s linear" } }),
                    React.createElement("line", { x1: tank2.x + 3, y1: "96", x2: tank2.x + tank2.w - 3, y2: "96", stroke: "#42546a", strokeWidth: "0.8" }),
                    React.createElement("line", { x1: tank2.x + 3, y1: "114", x2: tank2.x + tank2.w - 3, y2: "114", stroke: "#42546a", strokeWidth: "0.8" }),
                    React.createElement("rect", { x: "55", y: "134", width: "30", height: "14", fill: "url(#dvBand)", stroke: "#FF7A45", strokeWidth: "1", strokeOpacity: "0.7" }),
                    !stage1Gone && React.createElement(React.Fragment, null,
                        React.createElement("rect", { x: tank1.x, y: tank1.y, width: tank1.w, height: tank1.h, rx: "3", fill: "url(#dvMetal)", stroke: "#52E07C", strokeWidth: "1.2", strokeOpacity: "0.7" }),
                        React.createElement("rect", { x: tank1.x, y: tank1.y + (tank1.h - f1h), width: tank1.w, height: f1h, rx: "3", fill: "url(#dvFuelC)", opacity: "0.85", style: { transition: "height 2.6s linear, y 2.6s linear" } }),
                        React.createElement("line", { x1: tank1.x + 3, y1: "173", x2: tank1.x + tank1.w - 3, y2: "173", stroke: "#42546a", strokeWidth: "0.8" }),
                        React.createElement("line", { x1: tank1.x + 3, y1: "196", x2: tank1.x + tank1.w - 3, y2: "196", stroke: "#42546a", strokeWidth: "0.8" }),
                        React.createElement("line", { x1: tank1.x + 3, y1: "219", x2: tank1.x + tank1.w - 3, y2: "219", stroke: "#42546a", strokeWidth: "0.8" }),
                        React.createElement("path", { d: "M52,222 L40,242 L52,242 Z", fill: "url(#dvMetal)", stroke: "#52E07C", strokeWidth: "1", strokeOpacity: "0.7" }),
                        React.createElement("path", { d: "M88,222 L100,242 L88,242 Z", fill: "url(#dvMetal)", stroke: "#52E07C", strokeWidth: "1", strokeOpacity: "0.7" }),
                        React.createElement("path", { d: "M58,242 L62,250 L78,250 L82,242 Z", fill: "url(#dvBell)", stroke: "#FF7A45", strokeWidth: "1", strokeOpacity: "0.8" })))),
            deployed && (React.createElement("g", { className: "ls-fade", style: { animationDelay: "0.45s" } },
                [[22, 40], [176, 28], [40, 96], [168, 120], [24, 210], [182, 250], [96, 18]].map(([sx, sy], i) => (React.createElement("circle", { key: i, cx: sx, cy: sy, r: i % 3 === 0 ? 1.1 : 0.7, fill: "#ffffff", opacity: "0.55" }))),
                React.createElement("g", { transform: "rotate(-18 100 178)" },
                    React.createElement("ellipse", { cx: "100", cy: "178", rx: "82", ry: "34", fill: "none", stroke: "#4AF0E0", strokeWidth: "4.5", opacity: "0.13" }),
                    React.createElement("ellipse", { cx: "100", cy: "178", rx: "82", ry: "34", fill: "none", stroke: "#4AF0E0", strokeWidth: "1.2", strokeDasharray: "4 4", opacity: "0.85" }),
                    React.createElement("path", { id: "dvOrbitPath", d: "M100,144 a82,34 0 1,1 0,68 a82,34 0 1,1 0,-68", fill: "none", stroke: "none" })),
                React.createElement("circle", { cx: "100", cy: "178", r: "45", fill: "none", stroke: "#7fd4ff", strokeWidth: "4", opacity: "0.14" }),
                React.createElement("circle", { cx: "100", cy: "178", r: "42.5", fill: "none", stroke: "#9fe0ff", strokeWidth: "1", opacity: "0.3" }),
                React.createElement("circle", { cx: "100", cy: "178", r: "41", fill: "url(#dvOcean)" }),
                React.createElement("path", { d: "M76,168 q10,-12 24,-7 q14,5 10,17 q-4,11 -17,10 q-15,2 -19,-9 q-3,-7 2,-11 Z", fill: "#3aa66b", opacity: "0.9" }),
                React.createElement("path", { d: "M108,190 q10,-5 17,3 q7,10 -2,18 q-10,8 -17,0 q-7,-8 -5,-14 q2,-5 7,-7 Z", fill: "#379f65", opacity: "0.85" }),
                React.createElement("path", { d: "M85,200 q8,-3 13,3 q4,7 -3,11 q-11,5 -15,-3 q-2,-6 5,-11 Z", fill: "#2f8f5b", opacity: "0.8" }),
                React.createElement("ellipse", { cx: "102", cy: "152", rx: "14", ry: "3.4", fill: "#eaf5ff", opacity: "0.5" }),
                React.createElement("ellipse", { cx: "92", cy: "207", rx: "10", ry: "2.6", fill: "#eaf5ff", opacity: "0.35" }),
                React.createElement("circle", { cx: "100", cy: "178", r: "41", fill: "url(#dvNight)", style: { pointerEvents: "none" } }),
                React.createElement("g", null,
                    React.createElement("circle", { r: "10", fill: "#4AF0E0", opacity: "0.18" }),
                    React.createElement("rect", { x: "-4.5", y: "-3.5", width: "9", height: "7", rx: "1", fill: "url(#dvMetal)", stroke: "#4AF0E0", strokeWidth: "0.9" }),
                    React.createElement("line", { x1: "-4.5", y1: "0", x2: "-6.5", y2: "0", stroke: "#8fa3ba", strokeWidth: "1" }),
                    React.createElement("line", { x1: "4.5", y1: "0", x2: "6.5", y2: "0", stroke: "#8fa3ba", strokeWidth: "1" }),
                    React.createElement("rect", { x: "-14.5", y: "-2.6", width: "8", height: "5.2", rx: "0.6", fill: "url(#dvFuelC)", opacity: "0.9", stroke: "#178278", strokeWidth: "0.5" }),
                    React.createElement("rect", { x: "6.5", y: "-2.6", width: "8", height: "5.2", rx: "0.6", fill: "url(#dvFuelC)", opacity: "0.9", stroke: "#178278", strokeWidth: "0.5" }),
                    React.createElement("circle", { cx: "-1.2", cy: "-1.2", r: "1.1", fill: "#ffffff", opacity: "0.6" }),
                    React.createElement("animateMotion", { dur: "9s", repeatCount: "indefinite", rotate: "auto" },
                        React.createElement("mpath", { href: "#dvOrbitPath" }))),
                React.createElement("text", { x: "100", y: "262", textAnchor: "middle", fill: "#8A99B0", fontFamily: "ui-monospace, Menlo, monospace", fontSize: "8", letterSpacing: "2" }, "PAYLOAD IN ORBIT")))),
